...
* Використання bind, call, apply: виклик стрілкових функцій через call, apply, навіть якщо передати аргументи в ці методи (тобто передати контекст виконання) повпливає на значення this. Тобто: 
