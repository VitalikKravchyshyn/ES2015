...
В  ES 2015 появилась можливість встаки змінних, або результатів якихось 
...
Якщо метод викликається без привязки до об'єкту, то в середині методу this буде мати значення undefined. Щоб виправити це, потрібно привязати метод до об'єкту за допомогою bind(). Приклад:
...
Symbol.for(key) - створює глобальний символ з іменем key. І при на всіх наступних  зверненнях до Symbol.for(key) ми будемо отримувати один і той же символ. Тобто по факту створюється глобальний словник символів.
